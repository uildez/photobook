...
export function Gallery() {
  const { barSearch, isFetching, count, setCount, countSearch, setCountSearch, handleSearchChange, setBarSearch, searchWord } =
    useContext(UserContext);

  return (
    <>
      <div className="flex flex-col md:pt-32 justify-between items-center px-6 py-6 bg-slate-200 dark:bg-slate-700 md:px-24 mobile:pt-40">
        <div>
            ...
            <>
              ...
              {!isFetching && (
                <button
                  ...
                  onClick={() => {setCountSearch(countSearch + 20), handleSearchChange(searchWord)}}
                >
                  Search Load more
                </button>
              )}
